  ...
  days: [
    {
      ...
      exercises: [{ name: "Running", start: "2026-07-20T06:12:00Z", durationMinutes: 32, source: "com.google.android.apps.fitness" }],
      samples: [
        { metric: "heartRate", start: "2026-07-20T10:04:12Z", value: 68, source: "com.samsung.health" },
...
test("maps samples by record shape and skips unknown metrics", () => {
  ...
  assert.deepEqual(hr, { metric: "heartRate", start_at: "2026-07-20T10:04:12Z", end_at: null, value_num: 68, value_secondary: null, value_text: null, source: "com.samsung.health" });
...
test("maps exercises", () => {
  ...
  assert.deepEqual(ex, { name: "Running", start_at: "2026-07-20T06:12:00Z", duration_minutes: 32, source: "com.google.android.apps.fitness" });
});
